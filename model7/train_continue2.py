...
from train_continue_model import train_continue_model
from train_model import train_model


def main():
    data_base = DataModelEnum.M7D2
    ...
    train_continue_model(data_reader, model, batch_size, num_epochs, f'{data_reader.model_db}model_epoch_900.pth', 900)
